...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-7xl p-4 py-6 lg:py-8">
          ...
          <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/Harsh9327" target="_blank" className="hover:underline ">Github</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a to="https://flowbite.com/" className="hover:underline">Plug&Tug™</a>. All Rights Reserved.
          </span>
